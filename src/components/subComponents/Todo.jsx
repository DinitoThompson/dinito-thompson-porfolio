...
// Project Images
import TodoBG from "../../assets/fullstack/TodoList/React Editable Todo List.png";
  ...
  return (
    <div>
      <p className="my-4 text-white font-extralight tracking-widest">
        <span className="text-blue-400">Editable Todo List</span> - React
      </p>
      {/* Image */}
      ...
      <div>
        <div className="flex flex-row items-center justify-center">
          ...
          <a
            href="https://github.com/DinitoThompson/React-Editable-Todo-List"
