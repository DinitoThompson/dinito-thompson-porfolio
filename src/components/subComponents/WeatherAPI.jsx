...
// Project Images
import Rainy from "../../assets/fullstack/Weather App/rainy.webp";
import WeatherBG from "../../assets/fullstack/Weather App/React Weather App.png";
  ...
  return (
    <div>
      <p className="my-4 text-white font-extralight tracking-widest">
        <span className="text-orange-400">Weather App</span> - React
      </p>
      {/* Image */}
      ...
      <div>
        <div className="flex flex-row items-center justify-center">
          ...
          <a
            href="https://github.com/DinitoThompson/React-Weather-App"
