...
const About = () => {
  return (
    <div
      name="about"
      className="w-full h-screen bg-about-page bg-center bg-cover bg-fixed"
    >
      <div className="w-full h-screen bg-gradient-to-br from-black to-[#252629] opacity-[0.97] text-white">
