    ...
    >
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        <motion.h2
          ...
          className="text-2xl sm:text-3xl md:text-4xl font-bold mb-6 sm:mb-8 md:mb-10 text-center bg-clip-text text-transparent bg-gradient-to-r from-blue-400 via-purple-500 to-teal-400"
        >
          Skills & Expertise
        </motion.h2>
...
const SkillCategory = ({
  ...
  <motion.div
    ...
    className="bg-gray-800 bg-opacity-30 rounded-lg p-4 sm:p-6 shadow-lg hover:shadow-xl transition-all duration-300"
  >
